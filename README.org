...
1. @@html:<s>@@Protocol and broadcast struct@@html:</s>@@ --- done (Go, =main.go=)
2. @@html:<s>@@Unit tests for protocol@@html:</s>@@ --- done (=main_test.go=, =go test ./...=)
3. @@html:<s>@@Conflict detection with CPRR phase severity@@html:</s>@@ --- done
4. @@html:<s>@@CLI: announce, check, status, validate, doctor@@html:</s>@@ --- done
5. @@html:<s>@@Transport fanout: mesh, ggwave, kbfs, mdns, UDP@@html:</s>@@ --- done (v0.4.0)
6. @@html:<s>@@Wire format v3.1 with BNF grammar@@html:</s>@@ --- done (ADR accepted)
